...
public class Engine extends Thread {
    ...
    void earnEpoints()
    {
        url="https://www.socialtrade.biz/User/EarnePoints.aspx";
        get();
        save("2_1");
        url="https://www.socialtrade.biz/User/EarnePoints.aspx/ApplyBooster";
        body="{ 'userId':'"+userId+"','flag':'isavailablebooster'}";
        PostThread();
        save("2_2");
        url="https://www.socialtrade.biz/User/EarnePoints.aspx/GetWorkHistory";
    ...
    public void Automate()
    {
        ...
        while(state<7)
        {
           ...
           // System.out.println("called "+state);
            ...
            if(state==1)
            {
                url="https://www.socialtrade.biz/User/userdashboard.aspx";
                get();
...
//tree();
    ...
    {
        set("UW");
        url="https://www.socialtrade.biz/User/EarnePoints.aspx/UpdateTaskWork";
